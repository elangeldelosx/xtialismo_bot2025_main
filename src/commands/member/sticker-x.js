...
module.exports = {
  name: "sticker-x",
  description: "Crear stickers de imagen, gif o video (máximo 10 segundos).",
  commands: ["f", "s", "sticker-x", "fig"],
  usage: `${PREFIX}sticker-x (marcar o responder a una imagen/gif/video)`,
  handle: async ({
    isImage,
    isVideo,
    downloadImage,
    ...
    if (!isImage && !isVideo) {
      throw new InvalidParameterError(
        `xX| Se marca o responde a una imagen/gif/video |Xx`
      );
    }
